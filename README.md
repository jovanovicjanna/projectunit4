...
| 2       | Planning: Write down the problem definition                                                                | Have problem definition which will identify who client is and the product that client wants                                                                                                                                                                                  | 20 mins       | Apr 6                  | A         |
| 3       | Planning: Write the proposed solution and rationale for propsed solution                                   | Have a clear justification and reasoning that will suit both me and the client                                                                                                                                                                                               | 1 hour        | Apr 7                  | A         |
...
| 9       | Design: Create the flow diagram for key functions                                                          | Create flow diagrams that explain how the main functions of the website would be organized and carried out using natural language                                                                                                                                            | 2 hours       | Apr 19                 | B         |
...
| 14      | Develop: Create registration function                                                                      | Make registration function, use template from the "Learning log" and upgrade it, user will be able to enter properties such as email, username, password and biography and they will be stored in the database. Password is encrypted.                                       | 2 hours       | Apr 29                 | C         |
| 15      | Develop: Create login function                                                                             | Make login function, create cookies when the user successfully logged in, validation of username and password match                                                                                                                                                          | 1 hour        | May 1                  | C         |
| 16      | Develop: Create validation for login and register function                                                 | Add lines to the code which will display error messages if the input is not in format which is required                                                                                                                                                                      | 30 mins       | May 1                  | C         |
...
| 18      | Develop: Create validation for users input for function for posting reviews                                | Validate users input and ensure that the user can't upload empty post.                                                                                                                                                                                                       | 20 mins       | May 1                  | C         |
| 19      | Develop: Create delete function                                                                            | Adding an option for user to delete posts that they have created                                                                                                                                                                                                             | 20 mins       | May 2                  | C         |
| 20      | Develop: Add feature which displays datetime                                                               | Adding a feature that will display datetime when the post is created, accordingly, posts will be displayed in reverse chronological order (the newest one being at the top of the page)                                                                                      | 20 mins       | May 2                  | C         |
| 21      | Develop: Make function which will allow user to view all the posts posted on the social network            | Creating a function and a page on the website which will allow user to view all the posts posted on the social network and which user posted specific post                                                                                                                   | 45 mins       | May 2                  | C         |
...
| 23      | Develop: Create a function which will display users basic information                                      | Making a 'account' page which displays a basic information about user such as their username, id, email and biography                                                                                                                                                        | 15 mins       | May 4                  | C         |
...
| 30      | Evaluation: Test my program with client and another user                                                   | Ask the client and another user to do beta testing on the program                                                                                                                                                                                                            | 35 mins       | May 7                  | E         |
...
| 33      | Functionality: Write the script for the video                                                              | Write the script for the video                                                                                                                                                                                                                                               | 10 mins       | May 11                 | D         |
| 34      | Functionality: Create the video                                                                            | Create video that demonstrates the functionality and extensibility of the program                                                                                                                                                                                            | 15 mins       | May 11                 | D         |
## Test Table
| Instruction                                                  | Category               | Input/example code                                                                                                                                          | Description                                                                                                         | Expected output                                                                                                                                                                                                      | Success criteria |
|--------------------------------------------------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| Test registration function-success                           | Unit testing           | Username(test), Email(test@gmail.com), Password(12345678), Password confirmation(12345678), Biography(test)                                                 | Register an account, input username, email, password, password confirmation, and biography, all information correct | Users input successfully stored in the database, password hashed, and user is redirected to the 'login' page                                                                                                         | 1                |
| Test registration function - user already registered         | Unit testing           | Username(test123), Email(test123@gmail.com), Password(12345678), Password confirmation(12345678), Biography(test123)                                        | Input username or (and) email which is already stored in the database                                               | If email/username is already used error message displays "User with this email/username is already registered."                                                                                                      | 1                |
| Test registration function - Password error                  | Unit testing           | Username(test), Email(test@gmail.com), Password(123), Password confirmation(1234), Biography(test)                                                          | Input password which has less than 8 characters or the password and password confirmation do not match              | If passwords do not match or are less than 8 characters long error message displays "Passwords do not match or are not at least 8 characters long."                                                                  | 1                |
| Test registration function - username formatting             | Unit testing           | Username(test test), Email(test@gmail.com), Password(12345678), Password confirmation(12345678), Biography(test)                                            | Input username which contains space                                                                                 | If username contains spaces, error message displayed "Username must not contain spaces"                                                                                                                              | 1                |
| Test login function                                          | Unit testing           | Email(test@gmail.com), Password(12345678)                                                                                                                   | Input the correct email and password                                                                                | The user logs in if the email and password are correct.                                                                                                                                                              | 1                |
| Test login function                                          | Unit testing           | 1. Email(testtest@gmail.com), Password(12345678) 2. Email(test@gmail.com), Password(123456789)                                                              | Input email which doesn't exist in the database, or wrong password                                                  | The user is not able to log in and an error message is displayed "User with this email is not registered" or "Password incorrect"                                                                                    |                  |
| Test registration and login function                         | Integrated testing     | 1. Username(test), Email(test@gmail.com), Password(12345678), Password confirmation(12345678), Biography(test) 2. Email(test@gmail.com), Password(12345678) | Register with the account, than login                                                                               | The user successfully registered, than redirected to login page, user successfully logged in and redirected to the page where he can post reviews                                                                    | 1                |
...
| Test posting - success                                       | Unit testing           | Title(test),  rating(10),  review(test)                                                                                                                     | Input all the fields required                                                                                       | The user is able to view the post with the time it was created, posts arranged from the newest (on the top) to the oldest                                                                                            | 2                |
